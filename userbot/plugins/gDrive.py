...
from userbot import G_DRIVE_DATA, G_DRIVE_CLIENT_ID, G_DRIVE_CLIENT_SECRET, G_DRIVE_FOLDER_ID, BOTLOG_CHATID, TEMP_DOWNLOAD_DIRECTORY, CMD_HELP, LOGS
...
async def upload(gdrive, service, file_path, file_name, mimeType):
    ...
    body = {
        "name": file_name,
        "description": "Uploaded from Telegram using Wrench's UserBot.",
        "mimeType": mimeType,
    }
    try:
        if parent_Id is not None:
